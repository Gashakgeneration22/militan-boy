...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/proxy-template.py
chmod +x /usr/local/bin/edu-ssh

# Installing Service
cat > /etc/systemd/system/edussh-nontls.service << END
[Unit]
Description=Ssh Websocket By YakkoXCode
Documentation=https://t.me/YakkoXCode
