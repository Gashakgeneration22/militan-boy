...
# install v2ray
wget https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O renew-ws "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/renew-ws.sh"
wget -O renew-vless "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/renew-vless.sh"
wget -O renew-tr "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/renew-tr.sh"
wget -O certv2ray "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/cert.sh"
chmod +x add-ws
chmod +x add-vless
chmod +x add-tr
chmod +x del-ws
