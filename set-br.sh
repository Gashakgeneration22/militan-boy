...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/rclone.conf"
...
wget -O restore "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/restore.sh"
wget -O strt "https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/strt.sh"
